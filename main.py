...
class AIClient:
    ...
    def chat_completion(self, messages: List[Dict[str, str]], include_system: bool = True) -> Optional[str]:
...
🎯 <b>Что я умею:</b>
• 💬 Умное общение с AI (Llama-3.3-70B)
• 📚 Сохранение истории диалогов
• 👤 Персональный профиль и статистика
• 💎 Система подписок

🎁 <b>Бесплатно:</b>
• {DAILY_FREE_MESSAGES} сообщений в день
• Полная история чатов
• Обновление лимита каждые 24 часа
...
<i>Дата релиза: {datetime.now().strftime('%d.%m.%Y')}</i>
...
📊 <b>Ваша статистика:</b>
• Использовано сегодня: {user['daily_messages']}/{DAILY_FREE_MESSAGES}
• Следующее обновление: через 24 часа

💎 <b>Получите безлимитный доступ!</b>
• 1 месяц - 500₽
• 6 месяцев - 2500₽
• 12 месяцев - 4500₽
• Навсегда - 9999₽

<i>Приходите завтра или приобретайте подписку!</i>
        """
    ...
    try:
        ...
        ai_response = ai_client.chat_completion(history)
